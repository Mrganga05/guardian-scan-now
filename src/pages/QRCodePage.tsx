...
const QRCodePage = () => {
  ...
  const generateToken = async (profileData: ProfileData) => {
    ...
    try {
      ...
      if (!user) {
        // Fallback to base64 URL if not logged in
      ...
      // Build the public URL using the token
          ...
          <Button
            ...
            onClick={() => {
              ...
              img.onload = () => {
                ...
                ctx.fillText("Scan QR to view full profile", 300, 600);
            ...
            >
              ...
              <div className="bg-card p-6 space-y-6">
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    {[
                      { icon: "🏥", name: "Nearest Hospital", sub: "Search nearby" },
                      { icon: "🚑", name: "Ambulance", sub: "Call 108" },
                      { icon: "🚔", name: "Police", sub: "Call 100" },
                    ].map((s, i) => (
                      <div key={i} className="flex items-center justify-between p-4 rounded-xl border border-border bg-secondary/30">
                        <div className="flex items-center gap-3">
